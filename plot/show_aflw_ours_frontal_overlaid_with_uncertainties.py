...
ap.add_argument    ('-i', '--exp_id' , help = "path of the directory", default= "abhinav_model_dir/run_25_evaluate/")
args = ap.parse_args()
model_folder_path = os.path.join(args.exp_id, "aflw_ours_frontal")

print("Loading JSON data...")
with open('dataset/aflw_ours_frontal_val.json') as json_file:
    json_data = json.load(json_file)
print("Done")

print(len(json_data))
num_images = 50#len(data)
