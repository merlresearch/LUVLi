...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--data_dir', type=str, default='./dataset/300W',
                    help='training data or listfile path')
        self.parser.add_argument('--exp_dir',type=str, default='abhinav_model_dir',
        ...
        self.parser.add_argument('--dataset', type=str, default='face',  # change
                       help='dataset type')
